...
const HeroSection: FC = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden pb-16 md:pb-24 md:pt-4">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-heat-100 to-heat-200" />
      
      {/* Content container */}
      <div className="relative section-container grid md:grid-cols-2 gap-8 md:gap-4 items-center !py-0">
        {/* On mobile: headline first, then form */}
        <div className={`${isMobile ? 'order-1' : 'order-2 md:order-1'}`}>
          {/* Logo */}
          <div className="mb-4 md:mb-4 animate-fade-in flex justify-center">
            <img 
              src="/images/house2.png" 
              alt="Green Home Path Logo" 
              className="h-[350px] sm:h-[400px] md:h-[425px] lg:h-[475px] w-auto max-w-[500px] md:max-w-[575px] lg:max-w-[665px] object-contain"
            />
          </div>
